"""
HomeGoods scraper - Category-based enumeration (TJX Companies).
"""
...
class HomeGoodsScraper(BaseScraper):
    """HomeGoods.com scraper - category pagination approach."""
    ...
    def __init__(self, config, database, browser_manager, rate_limiter, proxy_manager):
        ...
        self.retailer_name = 'homegoods'
        self.base_url = 'https://www.homegoods.com'
    
    async def enumerate_products(self) -> List[Dict[str, str]]:
        """
        Enumerate HomeGoods products via category crawling.
        Note: No reliable sitemap, must crawl category pages.
        """
        products = []
        ...
        for page_num in range(1, max_pages + 1):
            ...
            for card in product_cards:
                ...
                if link:
                    ...
                    # Extract ID from URL or attribute
